export type NewspaperTemplateCategory =
  | 'CENTURY_STANDARD'
  | 'CENTURY_CHASE'
  | 'FIFTY_WIN'
  | 'FIFTY_LOSS'
...
export type NewspaperPlaceholder =
  | 'PLAYER'
  | 'TEAM'
  | 'OPPONENT'
  | 'RUNS'
...
export type NewspaperHeadlineFamily =
  | 'PLAYER_PERFORMANCE'
  | 'PLAYER_RECOGNITION'
  | 'PLAYER_JOURNEY'
  | 'TEAM_RESULT'
...
export interface NewspaperTemplate {
  readonly id: string;
  readonly category: NewspaperTemplateCategory;
  readonly headlineFamily: NewspaperHeadlineFamily;
  readonly headline: string;
  readonly deck: string;
  readonly body: string;
  readonly requiredPlaceholders: readonly NewspaperPlaceholder[];
}

const PLACEHOLDER = /\[([A-Z_]+)\]/g;

const COPY_SAFETY_CORRECTIONS: Readonly<
  Record<string, Partial<Pick<NewspaperTemplate, 'headline' | 'deck' | 'body'>>>
> = Object.freeze({
  'CS-01': {
    body: 'The scorecard records a substantial individual innings alongside the completed result.',
  },
  'CS-02': {
    body: 'The hundred adds a three-figure entry to [PLAYER]’s record. When the match ended, [OUTCOME_LINE].',
  },
  'CS-03': {
    deck: '[RUNS] from [BALLS] is [TEAM]’s three-figure contribution in [COMPETITION].',
    body: '[PLAYER] recorded a hundred against [OPPONENT], adding a major batting entry to the completed scorecard.',
  },
  'CS-04': {
    deck: '[TEAM_SCORE] includes [PLAYER]’s [RUNS] against [OPPONENT].',
    body: '[PLAYER] supplied a three-figure contribution for [TEAM]. [OUTCOME_LINE].',
  },
  'CS-05': {
    body: 'The completed scorecard records [PLAYER]’s hundred as [TEAM]’s major individual batting return.',
  },
  'CS-06': {
    body: 'The hundred is recorded within [TEAM]’s completed batting total and [PLAYER]’s season statistics.',
  },
  'CS-07': {
    body: '[TEAM] had a three-figure innings from [PLAYER]. When the contest was complete, [OUTCOME_LINE].',
  },
  'CC-01': {
    body: '[PLAYER] made a hundred in the completed pursuit as [TEAM] reached their target.',
  },
  'CC-02': {
    body: 'The target was [TARGET]; [PLAYER] contributed [RUNS] to [TEAM]’s successful chase.',
  },
  'CC-03': {
    deck: '[RUNS] from [BALLS] features in a successful chase against [OPPONENT].',
    body: '[PLAYER] recorded a hundred before [TEAM] completed the chase.',
  },
  'CC-04': {
    deck: '[PLAYER] scores [RUNS] as [TEAM] chase [TARGET].',
    body: 'The completed result pairs a successful chase with [PLAYER]’s three-figure score.',
  },
  'CC-05': {
    body: '[OPPONENT] set a total to defend; [TEAM] completed the chase with [PLAYER] scoring [RUNS].',
  },
  'CC-06': {
    deck: '[RUNS] is a three-figure contribution as [TEAM] beat [OPPONENT] by [MARGIN].',
    body: '[PLAYER]’s hundred is recorded within [TEAM]’s successful pursuit.',
  },
  'CC-07': {
    body: 'The completed scorecard pairs [PLAYER]’s hundred with [TEAM]’s successful chase.',
  },
  'CC-08': {
    body: 'The chase ended in [TEAM]’s favour with [PLAYER] contributing a three-figure innings.',
  },
  'FW-01': {
    body: 'The half-century is recorded as a substantial batting contribution in [TEAM]’s victory.',
  },
  'FW-02': { body: 'The completed victory includes [PLAYER]’s verified half-century.' },
  'FW-03': {
    body: 'The team result and [PLAYER]’s half-century are both recorded in the completed scorecard.',
  },
  'FW-04': {
    body: 'The completed scorecard records [PLAYER]’s half-century alongside [TEAM]’s winning margin.',
  },
  'FW-05': {
    body: 'The completed batting record includes [PLAYER]’s half-century and [TEAM]’s victory.',
  },
  'FW-07': { deck: '[TEAM] defeat [OPPONENT] by [MARGIN], including [PLAYER]’s [RUNS].' },
  'FW-08': {
    body: 'The half-century adds another verified score to [PLAYER]’s season record.',
  },
  'FL-01': {
    body: '[PLAYER] recorded a half-century, while the completed result belonged to [OPPONENT].',
  },
  'FL-03': { deck: '[RUNS] from [BALLS] features in [TEAM]’s effort as they lose by [MARGIN].' },
  'FL-04': {
    body: '[TEAM] recorded [PLAYER]’s half-century, but the completed result went to [OPPONENT].',
  },
  'FL-05': {
    deck: '[RUNS] from [BALLS] accompanies [TEAM]’s loss by [MARGIN].',
    body: 'The half-century remains a verified personal contribution within the completed defeat.',
  },
  'FL-07': {
    body: 'The result and the half-century enter separate parts of [PLAYER]’s completed match record.',
  },
  'FL-08': {
    body: '[TEAM]’s total includes [PLAYER]’s half-century; [OPPONENT] recorded the victory.',
  },
  'WS-01': {
    body: 'The scorecard records [WICKETS] dismissals for [PLAYER] alongside the completed result.',
  },
  'WS-02': {
    body: '[PLAYER]’s [WICKETS] dismissals form a verified multi-wicket return for [TEAM].',
  },
  'WS-03': { body: '[PLAYER] recorded [WICKETS] dismissals for [TEAM] against [OPPONENT].' },
  'WS-04': {
    body: 'The completed bowling card gives [PLAYER] a verified return of [WICKETS] wickets.',
  },
  'WS-05': {
    headline: '[PLAYER] TURNS SPELL INTO WICKETS',
    body: '[PLAYER] recorded [WICKETS] dismissals in the match decided by [MARGIN].',
  },
  'WS-07': {
    body: 'The completed bowling card records repeated dismissals for [PLAYER] against [OPPONENT].',
  },
  'WH-01': {
    deck: '[WICKETS] wickets give [PLAYER] a five-wicket return against [OPPONENT].',
    body: 'The completed innings records five or more [OPPONENT] dismissals for [PLAYER].',
  },
  'WH-02': {
    body: '[PLAYER]’s completed return reached five wickets or more against [OPPONENT].',
  },
  'WH-03': {
    body: 'The completed bowling card records a five-wicket return for [PLAYER].',
  },
  'WH-04': {
    body: 'The final result has its own line; [PLAYER]’s five-wicket achievement has another.',
  },
  'WH-05': {
    body: 'The haul gives [PLAYER] five or more verified dismissals in [TEAM]’s completed bowling card.',
  },
  'WH-06': {
    body: 'The completed bowling card gives [PLAYER] a verified return of five wickets or more.',
  },
  'WH-07': {
    deck: '[WICKETS] wickets give [PLAYER] a five-wicket return in the fixture.',
    body: 'The opposition innings records five or more dismissals credited to [PLAYER].',
  },
  'WH-08': { body: 'The final result and [PLAYER]’s verified five-wicket haul are both recorded.' },
  'AR-01': {
    headline: '[PLAYER] MAKES BAT AND BALL COUNT',
    body: 'The completed scorecard joins [RUNS] runs and [WICKETS] wickets in one all-round performance.',
  },
  'AR-02': {
    deck: '[RUNS] from [BALLS] and [WICKETS] wickets form [PLAYER]’s all-round return for [TEAM].',
  },
  'AR-03': {
    body: '[TEAM]’s completed scorecard records [PLAYER]’s contributions with both bat and ball.',
  },
  'AR-05': {
    body: '[PLAYER] supplied one verified batting contribution and one verified bowling contribution.',
  },
  'AR-06': {
    body: 'The completed scorecard records [PLAYER] in both the batting and bowling columns.',
  },
  'AR-07': {
    headline: '[PLAYER] SCORES AND BREAKS THROUGH',
    deck: '[RUNS] from [BALLS] and [WICKETS] wickets are recorded in [COMPETITION].',
    body: 'One line records [PLAYER]’s runs; another records the dismissals credited to [PLAYER].',
  },
  'AR-08': {
    body: 'The result came from a full team, while [PLAYER] supplied verified contributions in both disciplines.',
  },
  'CW-01': {
    headline: '[TEAM] TAKE A NARROW WIN',
    body: 'The final margin records how little separated the sides at the completion of the match.',
  },
  'CW-02': { body: 'The completed result places [TEAM] on the winning side of a narrow margin.' },
  'CW-03': {
    headline: '[PLAYER] FEATURES IN A NARROW WIN',
    body: '[PLAYER]’s Player of the Match award sits alongside [TEAM]’s narrow victory.',
  },
  'CW-04': {
    body: 'The final margin is narrow, and [PLAYER]’s [PERFORMANCE_LINE] is part of the completed scorecard.',
  },
  'CW-06': {
    body: '[PLAYER]’s Player of the Match award is recorded alongside the close team result.',
  },
  'CW-07': { body: 'The completed result places [TEAM] just far enough ahead to take the win.' },
  'CW-08': {
    headline: '[PLAYER] FEATURES IN THE CLOSE RESULT',
    body: '[PLAYER]’s contribution and [TEAM]’s narrow victory are both recorded.',
  },
  'CL-01': { body: '[PLAYER]’s contribution is recorded alongside [TEAM]’s narrow defeat.' },
  'CL-02': {
    deck: '[PLAYER] records [PERFORMANCE_LINE] as [TEAM] lose by [MARGIN].',
    body: 'The teams finished close together, with the completed result belonging to [OPPONENT].',
  },
  'CL-04': {
    body: '[PLAYER]’s [PERFORMANCE_LINE] accompanies a close result that belonged to [OPPONENT].',
  },
  'CL-07': {
    body: '[PLAYER]’s [PERFORMANCE_LINE] is recorded alongside [OPPONENT]’s narrow victory.',
  },
  'PM-01': {
    deck: '[PLAYER] is named Player of the Match after recording [PERFORMANCE_LINE] against [OPPONENT].',
    body: 'The award and the completed team result are recorded as separate facts from the fixture.',
  },
  'PM-03': {
    body: 'The completed fixture records [PLAYER] as Player of the Match.',
  },
  'PM-04': {
    deck: '[PLAYER] records [PERFORMANCE_LINE] and receives the individual honour in [COMPETITION].',
  },
  'PM-06': {
    deck: '[PLAYER] records [PERFORMANCE_LINE] and is named Player of the Match at [VENUE].',
    body: 'The completed fixture records the performance and the award together.',
  },
  'PM-07': {
    deck: '[PLAYER] is named Player of the Match after recording [PERFORMANCE_LINE] against [OPPONENT].',
  },
  'PM-08': {
    body: '[PERFORMANCE_LINE] and the Player of the Match award are both recorded for [PLAYER].',
  },
  'TR-01': {
    body: '[TEAM] are the confirmed champions of [COMPETITION]. Their name now enters the season’s roll of honour.',
  },
  'TR-05': {
    deck: '[TEAM] finish [COMPETITION] with [TROPHY].',
    body: 'The championship is official. [SEASON] will list [TEAM] as the side that finished with the prize.',
  },
  'PC-06': {
    body: 'The confirmed move closes [PLAYER]’s [FROM_LEVEL] chapter and opens the [TO_LEVEL] assignment.',
  },
  'EX-09': {
    body: 'Elimination supplies the final line of this campaign and closes [TEAM]’s tournament schedule.',
  },
});
...
function headlineFamily(
  ...
  headline: string,
): NewspaperHeadlineFamily {
  if (category === 'PROMOTION') return 'PLAYER_JOURNEY';
  if (category === 'MILESTONE_RECORD') return 'RECORD_FOCUS';
  if (headline.startsWith('[TEAM]')) return 'TEAM_RESULT';
  if (headline.startsWith('[OPPONENT]')) return 'OPPOSITION_RESULT';
  if (headline.startsWith('[TROPHY]')) return 'TROPHY_FOCUS';
  if (!headline.startsWith('[PLAYER]')) return 'EVENT_RESULT';
  if (/HONOUR|AWARD|SPOTLIGHT|CENTRE STAGE|STANDS ABOVE|LAST SAY|LEAVES NO DOUBT/.test(headline)) {
    return 'PLAYER_RECOGNITION';
  }
  return 'PLAYER_PERFORMANCE';
}

function placeholdersFor(...copy: string[]): readonly NewspaperPlaceholder[] {
  const found = new Set<NewspaperPlaceholder>();
  for (const value of copy) {
    for (const match of value.matchAll(PLACEHOLDER)) {
      found.add(match[1] as NewspaperPlaceholder);
    }
  }
...
function parseCategory(
  category: NewspaperTemplateCategory,
  raw: string,
): readonly NewspaperTemplate[] {
  return Object.freeze(
    raw
      .trim()
      .split('\n')
      .map((line) => {
        const [id, initialHeadline, initialDeck, initialBody, ...extra] = line.split('|');
        if (!id || !initialHeadline || !initialDeck || !initialBody || extra.length > 0) {
          throw new Error(`Invalid newspaper template row in ${category}: ${line}`);
        }
        // The old safety layer was deliberately literal, but it read like a
        // database receipt ("verified", "completed scorecard") rather than a
        // newspaper. The original catalogue is fact-gated by the renderer and
        // is both truthful and substantially more editorial.
        const useLegacySafetyCopy = false;
        const correction: Partial<Pick<NewspaperTemplate, 'headline' | 'deck' | 'body'>> =
          useLegacySafetyCopy ? (COPY_SAFETY_CORRECTIONS[id] ?? {}) : {};
        const headline = correction.headline ?? initialHeadline;
        const deck = correction.deck ?? initialDeck;
        const body = correction.body ?? initialBody;
        return Object.freeze({
          id,
          category,
          headlineFamily: headlineFamily(category, headline),
          headline,
          deck,
          body,
          requiredPlaceholders: placeholdersFor(headline, deck, body),
        });
      }),
  );
}

export const NEWSPAPER_TEMPLATES: readonly NewspaperTemplate[] = Object.freeze([
  ...parseCategory(
    'CENTURY_STANDARD',
    `
...
PC-03|PROMOTION EARNED, CHALLENGE RENEWED|[PLAYER] advances from [FROM_LEVEL] to [TO_LEVEL].|The promotion follows [PLAYER]’s work at [FROM_LEVEL]. The next assignment is clear: earn a place and contribute at [TO_LEVEL].
...
export function newspaperTemplatesFor(
  category: NewspaperTemplateCategory,
): readonly NewspaperTemplate[] {
  return Object.freeze(NEWSPAPER_TEMPLATES.filter((template) => template.category === category));
}
