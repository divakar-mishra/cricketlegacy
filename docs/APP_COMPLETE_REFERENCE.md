...
| `manager_legend_pack`    | Manager Legacy Edition     |         INR 999 | Manager VIP, backing/office, board floor 82, first-grant club rep +3 capped 95, two scout tokens, one facility token and one recovery token | Manager       | Manager hero only     |
